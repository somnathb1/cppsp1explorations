This one wraps c implementation of basic fibonacci program and calls it from rust, and generates proofs.

Need to install @xpack-dev-tools for this to work, or use the default one provided by `sp1up --c-toolchain`
